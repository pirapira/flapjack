...
normally, or from a returned value list that was assigned to the destinations.
Keeping these cases separate makes the returned-value branch explicit in the
