...
/-!
Fuel-polymorphic composition for a nonzero loop whose body terminates
normally.  This is the recursive loop case used by the full correctness
induction.
-/
...
theorem compile_full_pan_value_while_nonzero_compose_fuel
...
theorem compile_full_pan_value_while_nonzero_compose_state_fuel
    [BEq α] [LawfulBEq α] [OfNat α 0] [OfNat α 1] [Add α] [Mul α]
    [Sub α] [AndOp α] [OrOp α] [HXor α α α] [ShiftLeft α] [ShiftRight α]
    [LT α] [DecidableRel (fun left right : α => left < right)] [PanCmp α]
    (context : CompileContext α) (structs : StructContext)
