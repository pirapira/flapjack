...
theorem panValueCrepProgramStateCorrect_extCall_source_word
                  ...
                  | succ targetFuel =>
                      ...
                      | succ targetFuel =>
                          ...
                          have hconfigurationEvalState := hstateExpFromLegacy
                            ...
                            hconfigurationSource hcompileConfiguration hconfigurationEval
                          ...
                          have hconfigurationLengthEvalState := hstateExpFromLegacy
                            ...
                            hconfigurationLengthSource hcompileConfigurationLength
                            hconfigurationLengthEval'
                          ...
                          dsimp [stateAfterConfiguration, stateAfterConfigurationLength,
                            stateAfterArray] at hconfigurationLengthEvalState
                          dsimp [stateAfterConfiguration, stateAfterConfigurationLength]
                            at harrayEvalState
                          dsimp [stateAfterConfiguration, stateAfterConfigurationLength,
                            stateAfterArray] at harrayLengthEvalState
                          ...
                          | some result =>
                              ...
                              have htargetExpected :
                                ...
                                simp [evalCrepFullProgState, updateCrepLocal,
                                  ...
                                  hconfigurationLengthEvalState, harrayEvalState,
                                  harrayLengthEvalState, hcall, restoreCrepResult,
                                  restoreCrepFfiTemps]
                              have hcrep' :
                                  evalCrepFullProgState functions crepPrimitive ffi sharedMem
                                    baseAddress topAddress (targetFuel + 5) state
