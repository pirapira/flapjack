...
theorem panValuePcCompileCorrect_compact_annot
    ...
    PanValuePcCompileCorrect
      ...
      codeRel excpRel exceptionCode globalsLookup (.annot tag text : Prog α) := by
  exact panValuePcCompileCorrect_compact_with_raised_state_evidence
    (.annot tag text) codeRel excpRel exceptionCode globalsLookup sourceFunctions
    functions primitive sourceHandler crepPrimitive ffi sharedMem baseAddress
    topAddress bytesInWord sourceFuel targetFuel
