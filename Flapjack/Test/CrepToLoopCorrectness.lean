...
theorem crepToLoop_primitive_assign_shift_const_var_contract_regression :
    CrepToLoopProgramCorrectWithPrimitive
      (.assign 8 (.shift .lsl (.const (3 : Nat)) (.var 5)) : CrepProg Nat) := by
  exact crepToLoopProgramCorrectWithPrimitive_assign_lsl_const_var 8 3 5

theorem crepToLoop_primitive_assign_shift_var_const_contract_regression :
    CrepToLoopProgramCorrectWithPrimitive
      (.assign 8 (.shift .lsr (.var 5) (.const 1)) : CrepProg Nat) := by
  exact crepToLoopProgramCorrectWithPrimitive_assign_lsr_var_const 8 5 1
...
theorem crepToLoop_store32_var_address_contract_regression :
    (evalCrepFullProg [] (fun _ _ => none) (fun _ _ _ _ _ _ => none)
      (fun _ _ _ _ => none) 0 100 3 crepLoopAssignState
      (.store32 (.var 5) (.const 42))).map
        (crepControlMemoryAt 1) =
    (evalLoopProgWithCallsAndFfi [] (fun _ _ _ _ _ loopState => some loopState)
      7 (loopStateOfCrepState crepLoopAssignState)
      (loopCompileProg
        ...
        [] (.store32 (.var 5) (.const 42)))).map
        (loopControlMemoryAt 1) := by
  exact crepToLoop_store32_var_address_agreement
    ({ vars := [], functions := [], maxVar := 5, target := .rv64i } :
      LoopContext Nat)
    [] (fun _ _ => none) (fun _ _ _ _ _ _ => none) (fun _ _ _ _ => none)
    0 100 2 crepLoopAssignState [] 1 5 42
    (by simp [crepLoopAssignState])

theorem crepToLoop_storeByte_var_address_contract_regression :
    (evalCrepFullProg [] (fun _ _ => none) (fun _ _ _ _ _ _ => none)
      (fun _ _ _ _ => none) 0 100 3 crepLoopAssignState
      (.storeByte (.var 5) (.const 42))).map
        (crepControlMemoryAt 1) =
    (evalLoopProgWithCallsAndFfi [] (fun _ _ _ _ _ loopState => some loopState)
      7 (loopStateOfCrepState crepLoopAssignState)
      (loopCompileProg
        ...
        [] (.storeByte (.var 5) (.const 42)))).map
        (loopControlMemoryAt 1) := by
  exact crepToLoop_storeByte_var_address_agreement
    ({ vars := [], functions := [], maxVar := 5, target := .rv64i } :
      LoopContext Nat)
    [] (fun _ _ => none) (fun _ _ _ _ _ _ => none) (fun _ _ _ _ => none)
    0 100 2 crepLoopAssignState [] 1 5 42
...
theorem crepToLoop_store32_vars_contract_regression :
    (evalCrepFullProg [] (fun _ _ => none) (fun _ _ _ _ _ _ => none)
      (fun _ _ _ _ => none) 0 100 3 crepLoopStoreVarsState
      (.store32 (.var 5) (.var 6))).map
        (crepControlMemoryAt 1) =
    (evalLoopProgWithCallsAndFfi [] (fun _ _ _ _ _ loopState => some loopState)
      7 (loopStateOfCrepState crepLoopStoreVarsState)
      (loopCompileProg
        ({ vars := [], functions := [], maxVar := 6, target := .rv64i } :
          LoopContext Nat)
        [] (.store32 (.var 5) (.var 6)))).map
        (loopControlMemoryAt 1) := by
  exact crepToLoop_store32_vars_agreement
    ({ vars := [], functions := [], maxVar := 6, target := .rv64i } :
      LoopContext Nat)
    [] (fun _ _ => none) (fun _ _ _ _ _ _ => none) (fun _ _ _ _ => none)
    0 100 2 crepLoopStoreVarsState [] 1 42 5 6
...
theorem crepToLoop_storeByte_vars_contract_regression :
    (evalCrepFullProg [] (fun _ _ => none) (fun _ _ _ _ _ _ => none)
      (fun _ _ _ _ => none) 0 100 3 crepLoopStoreVarsState
      (.storeByte (.var 5) (.var 6))).map
        (crepControlMemoryAt 1) =
    (evalLoopProgWithCallsAndFfi [] (fun _ _ _ _ _ loopState => some loopState)
      7 (loopStateOfCrepState crepLoopStoreVarsState)
      (loopCompileProg
        ...
        [] (.storeByte (.var 5) (.var 6)))).map
        (loopControlMemoryAt 1) := by
  exact crepToLoop_storeByte_vars_agreement
    ({ vars := [], functions := [], maxVar := 6, target := .rv64i } :
      LoopContext Nat)
    [] (fun _ _ => none) (fun _ _ _ _ _ _ => none) (fun _ _ _ _ => none)
    0 100 2 crepLoopStoreVarsState [] 1 42 5 6
