...
#check @Flapjack.PanValuePcIndexedSemanticClockEvidence
#check @Flapjack.PanValuePcSemanticClockEvidence.toIndexed
#check @Flapjack.panCrepSemanticAgreement_of_indexed_pcCompileCorrect_evidence
#check @Flapjack.panCrepSemanticAgreement_of_indexed_pcCompileCorrect_evidence_of_cross_result
