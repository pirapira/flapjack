...
-- They are uncited execution checks, not theorem statements. `#guard`
-- keeps the exact output assertions without generating proof axioms.
#guard flattenAt false (.ite 1 2 3 .skip .tick) ==
  ([.labAsm (.jumpCmp 1 2 3 (.lab 3 2)) (BitVec.ofNat 64 0) [] 0,
    .asm (.asmi 90) [] 0, .label 3 2 0], false, 3)

#guard flattenAt false (.call none (.inl 11) none) ==
  ([.labAsm (.jump (.lab 11 0)) (BitVec.ofNat 64 0) [] 0], true, 2)

#guard flattenAt false (.break 1) 2 [] [4, 9] ==
  ([.labAsm (.jump (.lab 3 9)) (BitVec.ofNat 64 0) [] 0], true, 2)
...
#guard progToSection probeOps (BitVec.ofNat 64 0) 3 (.skip : ProbeProg) ==
    { sectionId := 3, lines := [.label 3 1 0] }

#guard progToSection probeOps (BitVec.ofNat 64 0) 3
    (.seq .tick (.inst 4) : ProbeProg) ==
    { sectionId := 3, lines := [.asm (.asmi 90) [] 0, .label 3 1 0,
      .asm (.asmi 4) [] 0, .label 3 2 0] }
...
#guard progToSection probeOps (BitVec.ofNat 64 0) 3
    ...
    { sectionId := 3, lines :=
      [.labAsm (.jumpCmp 1 1 2 (.lab 3 2)) (BitVec.ofNat 64 0) [] 0,
       ...
       .label 3 2 0, .asm (.asmi 90) [] 0, .label 3 3 0, .label 3 1 0] }
