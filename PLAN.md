...
- [x] Prove the word shared-memory load boundary, including assignment shape
  validation and the Crep shared-memory handler transition.
- [x] Prove the word shared-memory store boundary, including compiler-created
  temporary slots and their restoration after the handler transition.
