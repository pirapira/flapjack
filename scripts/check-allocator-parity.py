...
FIXTURES = (
    ...
    REPO_ROOT / "Flapjack" / "Test" / "OriginalPancake" / "f00003_fuzz_global_pressure_20260927.pnk",
    ...
    REPO_ROOT / "Flapjack" / "Test" / "OriginalPancake" / "wide_return_22.pnk",
    ...
    REPO_ROOT / "Flapjack" / "Test" / "OriginalPancake" / "f860_try_loop_large_constant.pnk",
    ...
    REPO_ROOT / "Flapjack" / "Test" / "OriginalPancake" / "parameter_reassignment.pnk",
    REPO_ROOT / "Flapjack" / "Test" / "OriginalPancake" / "loop_local.pnk",
    REPO_ROOT / "Flapjack" / "Test" / "OriginalPancake" / "loop_to_word_exception_fallback.pnk",
    REPO_ROOT / "Flapjack" / "Test" / "OriginalPancake" / "loop_to_word_unbound_var.pnk",
    ...
    REPO_ROOT / "Flapjack" / "Test" / "OriginalPancake" / "f00080_fuzz_pressure_20260923.pnk",
    REPO_ROOT / "Flapjack" / "Test" / "OriginalPancake" / "f00017_fuzz_allocator_20260923.pnk",
