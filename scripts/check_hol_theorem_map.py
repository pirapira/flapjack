...
def build_inventory(root: Path = ROOT) -> list[dict[str, Any]]:
    ...
    reviewed_exact = {
        ...
        ("Flapjack/Pancake/Proofs/PanGlobals.lean", "compile_decs_decls_thm_threaded"),
        ("Flapjack/Pancake/Proofs/PanGlobals.lean", "compile_decs_EVERY_is_function_threaded"),
        ("Flapjack/Pancake/Proofs/PanGlobals.lean", "compile_decls_append_threaded"),
